...
of the function and corresponding toy language function is as below:\\\\
\textbf{Definition of $POPWORD$}
\begin{gather*}
    POPWORD(w,i) = w'\ \ \ \ \ \ where\ w' \leq w \And |w'| = i
\end{gather*}
\textbf{Toy language function of $popWord$}
\begin{gather*}
...
word-adding operation. All the prefixes of $w$ should exist in $t$ eventually, 
...
$POPWORD(w, i+1)$. The definition of the function and the refinement of its 
linking procedure is as follows.\\\\
\textbf{Refinement of the procedure in doAddword}
\begin{gather*}
    \text{something to write here}
\end{gather*}
\textbf{Refinement of the procedure in doAddword}
\begin{gather*}
    \text{something to write here}
...
\end{align*}
\subsection{Refinement of Initialisation}
